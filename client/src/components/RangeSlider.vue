    ...
    <div class="range">
      <div class="p-1">
        <button
          ...
          @click="decCoeff()"
          v-b-tooltip.hover
          title="Decrease Attribute Weight"
        >
      ...
      <div class="p-1">
        <button
          ...
          @click="incCoeff()"
          v-b-tooltip.hover
          title="Increase Attribute Weight"
        >
...
input[type="range"] {
  ...
  &:hover::-webkit-slider-runnable-track {
    background: darken(rgba($color-red, 0.95), 8%);
  }
  &:focus:not([disabled])::-webkit-slider-runnable-track {
    background: darken(rgba($color-red, 0.95), 8%);
  }
